...
ADAPTER_PATH = Path(
    ...
    "medgemma_27b_morphology_qlora_full/"
    "best_adapter"
)
...
OUTPUT_DIR = Path(
    ...
    "medgemma_27b_morphology_qlora_final"
)

PREDICTIONS_FILE = (
    OUTPUT_DIR
    / "medgemma_27b_morphology_three_mode_predictions.csv"
)


SUMMARY_FILE = (
    OUTPUT_DIR
    / "medgemma_27b_morphology_three_mode_summary_metrics.csv"
)

PRIMARY_COMPARISON_FILE = (
    OUTPUT_DIR
    / "medgemma_27b_morphology_primary_all_test_comparison.csv"
)


RUN_SUMMARY_FILE = (
    OUTPUT_DIR
    / "medgemma_27b_morphology_evaluation_run_summary.json"
)
...
# Preserve the diagnostic conclusion and MORPHOLOGY_CODE
...
print("\n" + "=" * 100)
print("STARTING MEDGEMMA-27B MORPHOLOGY THREE-MODE EVALUATION")
print("=" * 100)
...
def calculate_metrics(
    ...
    # morphology classes. INVALID_LABEL remains in y_pred so
...
print("\n" + "=" * 120)
print("MEDGEMMA-27B MORPHOLOGY THREE-MODE SUMMARY METRICS")
print("=" * 120)
