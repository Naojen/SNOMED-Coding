...
ADAPTER_PATH = Path(
    ...
    "llama3_70b_morphology_qlora_full"
)
...
OUTPUT_DIR = Path(
    ...
    "llama3_70b_morphology_qlora_final"
)

PREDICTIONS_FILE = (
    OUTPUT_DIR
    / "llama3_70b_morphology_three_mode_predictions.csv"
)

SUMMARY_FILE = (
    OUTPUT_DIR
    / "llama3_70b_morphology_three_mode_summary_metrics.csv"
)

PRIMARY_COMPARISON_FILE = (
    OUTPUT_DIR
    / "llama3_70b_morphology_primary_all_test_comparison.csv"
)

RUN_SUMMARY_FILE = (
    OUTPUT_DIR
    / "llama3_70b_morphology_evaluation_run_summary.json"
)
...
if torch.cuda.device_count() != 8:
    raise RuntimeError(
        "This evaluation requires exactly 8 visible GPUs, "
...
print("=" * 100)
print("LOADING MORPHOLOGY TRAINING AND TEST DATA")
print("=" * 100)
...
if len(test_records) != 4287:
    print(
        "WARNING: Expected 4,287 test reports, but found",
        len(test_records),
    )
...
# Preserve the diagnostic conclusion and the response cue when
# a report exceeds the configured inference context length.
...
print("\n" + "=" * 100)
print("LOADING BEST MORPHOLOGY ADAPTER")
print("=" * 100)
...
print("\n" + "=" * 100)
print("STARTING LLAMA-3-70B-INSTRUCT MORPHOLOGY THREE-MODE EVALUATION")
print("=" * 100)
...
def calculate_metrics(
    ...
    # Class-averaged metrics are defined over genuine
    # ground-truth morphology classes. INVALID_LABEL remains in
    # y_pred so malformed generations are still counted as
    # incorrect predictions and false negatives, but it is not
    # treated as an artificial clinical class in macro-F1.
...
print("\n" + "=" * 120)
print("LLAMA-3-70B-INSTRUCT MORPHOLOGY THREE-MODE SUMMARY METRICS")
print("=" * 120)
...
run_summary = {
    ...
    "pcd_candidate_source": (
        "unique morphology codes in morphology_train.jsonl"
    ),
