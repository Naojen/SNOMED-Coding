...
if accelerator.is_main_process:
    print("\n" + "=" * 90)
    print("LOADING MORPHOLOGY DATASETS")
    print("=" * 90)
...
with accelerator.main_process_first():
    dataset = dataset.map(
        ...
        desc="Formatting morphology data",
    )
...
accelerator.print("\n" + "=" * 90)
accelerator.print(
    "CREATING MEDGEMMA-27B MORPHOLOGY "
...
accelerator.print("\n" + "=" * 90)
accelerator.print(
    "STARTING MEDGEMMA-27B MORPHOLOGY "
